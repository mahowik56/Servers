...
namespace UTanksServer.Database.Databases.UserTables {
    public class Users {
        ...
        private static readonly string _updateCrystallsSql =
        "UPDATE Users SET Crystalls = @cr WHERE Username = @un LIMIT 1;";
        ...
        public async Task UpdateCrystallsAsync(string username, int crystalls)
        {
            const string sql =
                "UPDATE Users SET Crystalls = @cr WHERE Username = @un COLLATE NOCASE;";
